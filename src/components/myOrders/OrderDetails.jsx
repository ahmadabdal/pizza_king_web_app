        ...
        <main>
          ...
          <article>
            ...
            <div>
              <h4>Onion Pizza</h4>
              <div>
                <span>{order.orderItems.onionPizza.quantity}</span> x{" "}
                <span>{order.orderItems.onionPizza.price}</span>
              </div>
            </div>
            <div>
              <h4>Paneer Cheese Pizza</h4>
              <div>
                <span>{order.orderItems.paneerCheesePizza.quantity}</span> x{" "}
                <span>{order.orderItems.paneerCheesePizza.price}</span>
              </div>
            </div>
